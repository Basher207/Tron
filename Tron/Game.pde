class Game {
  ...
  void SetupLevel1 () {
    ...
    itemSpawners.add(new ItemSpawner(new GridVector (width / 4, height / 4), 500));
    itemSpawners.add(new ItemSpawner(new GridVector (width - width / 4, height - height / 4), 500));
    itemSpawners.add(new ItemSpawner(new GridVector (width - width / 4, height / 4), 500));
    itemSpawners.add(new ItemSpawner(new GridVector (width / 4, height - height / 4), 500));
